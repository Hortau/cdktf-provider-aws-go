...
func init() {
	...
	_jsii_.RegisterStruct(
		"hashicorp_aws.backup.BackupSelectionCondition",
		reflect.TypeOf((*BackupSelectionCondition)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"hashicorp_aws.backup.BackupSelectionConditionStringEquals",
		reflect.TypeOf((*BackupSelectionConditionStringEquals)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"hashicorp_aws.backup.BackupSelectionConditionStringLike",
		reflect.TypeOf((*BackupSelectionConditionStringLike)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"hashicorp_aws.backup.BackupSelectionConditionStringNotEquals",
		reflect.TypeOf((*BackupSelectionConditionStringNotEquals)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"hashicorp_aws.backup.BackupSelectionConditionStringNotLike",
