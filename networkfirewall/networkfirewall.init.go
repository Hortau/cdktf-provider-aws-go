...
func init() {
	...
	_jsii_.RegisterStruct(
		"hashicorp_aws.networkfirewall.NetworkfirewallFirewallPolicyFirewallPolicyStatefulEngineOptions",
	...
	_jsii_.RegisterStruct(
		"hashicorp_aws.networkfirewall.NetworkfirewallRuleGroupRuleGroupStatefulRuleOptions",
