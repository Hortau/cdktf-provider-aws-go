...
func init() {
	...
	_jsii_.RegisterStruct(
		"hashicorp_aws.timestreamwrite.TimestreamwriteTableMagneticStoreWriteProperties",
		reflect.TypeOf((*TimestreamwriteTableMagneticStoreWriteProperties)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"hashicorp_aws.timestreamwrite.TimestreamwriteTableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocation",
	...
	_jsii_.RegisterStruct(
		"hashicorp_aws.timestreamwrite.TimestreamwriteTableMagneticStoreWritePropertiesMagneticStoreRejectedDataLocationS3Configuration",
