...
func init() {
	...
	_jsii_.RegisterStruct(
		"hashicorp_aws.datapipeline.DataAwsDatapipelinePipelineConfig",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "overrideLogicalId", GoMethod: "OverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "parameterObject", GoMethod: "ParameterObject"},
			...
			_jsii_.MemberProperty{JsiiProperty: "pipelineId", GoGetter: "PipelineId"},
			_jsii_.MemberProperty{JsiiProperty: "pipelineIdInput", GoGetter: "PipelineIdInput"},
			_jsii_.MemberMethod{JsiiMethod: "pipelineObject", GoMethod: "PipelineObject"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
	...
	_jsii_.RegisterStruct(
		"hashicorp_aws.datapipeline.DataAwsDatapipelinePipelineDefinitionConfig",
	...
	_jsii_.RegisterStruct(
		"hashicorp_aws.datapipeline.DataAwsDatapipelinePipelineDefinitionParameterValue",
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "parameterObjectInput", GoGetter: "ParameterObjectInput"},
			_jsii_.MemberProperty{JsiiProperty: "parameterValue", GoGetter: "ParameterValue"},
			_jsii_.MemberProperty{JsiiProperty: "parameterValueInput", GoGetter: "ParameterValueInput"},
			_jsii_.MemberProperty{JsiiProperty: "pipelineId", GoGetter: "PipelineId"},
			_jsii_.MemberProperty{JsiiProperty: "pipelineIdInput", GoGetter: "PipelineIdInput"},
			_jsii_.MemberProperty{JsiiProperty: "pipelineObject", GoGetter: "PipelineObject"},
			_jsii_.MemberProperty{JsiiProperty: "pipelineObjectInput", GoGetter: "PipelineObjectInput"},
			_jsii_.MemberProperty{JsiiProperty: "provider", GoGetter: "Provider"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
	...
	_jsii_.RegisterStruct(
		"hashicorp_aws.datapipeline.DatapipelinePipelineDefinitionConfig",
		reflect.TypeOf((*DatapipelinePipelineDefinitionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"hashicorp_aws.datapipeline.DatapipelinePipelineDefinitionParameterObject",
		reflect.TypeOf((*DatapipelinePipelineDefinitionParameterObject)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"hashicorp_aws.datapipeline.DatapipelinePipelineDefinitionParameterObjectAttribute",
		reflect.TypeOf((*DatapipelinePipelineDefinitionParameterObjectAttribute)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"hashicorp_aws.datapipeline.DatapipelinePipelineDefinitionParameterValue",
		reflect.TypeOf((*DatapipelinePipelineDefinitionParameterValue)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"hashicorp_aws.datapipeline.DatapipelinePipelineDefinitionPipelineObject",
		reflect.TypeOf((*DatapipelinePipelineDefinitionPipelineObject)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"hashicorp_aws.datapipeline.DatapipelinePipelineDefinitionPipelineObjectField",
