...
func (j *jsiiProxy_DevicefarmProject) Tags() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tags",
...
func (j *jsiiProxy_DevicefarmProject) TagsAll() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsAll",
...
func (j *jsiiProxy_DevicefarmProject) TagsAllInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsAllInput",
...
func (j *jsiiProxy_DevicefarmProject) TagsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagsInput",
...
func (j *jsiiProxy_DevicefarmProject) SetTags(val interface{}) {
	_jsii_.Set(
		j,
		"tags",
		val,
...
func (j *jsiiProxy_DevicefarmProject) SetTagsAll(val interface{}) {
	_jsii_.Set(
		j,
		"tagsAll",
		val,
...
type DevicefarmProjectConfig struct {
	...
	DefaultJobTimeoutMinutes *float64 `json:"defaultJobTimeoutMinutes"`
