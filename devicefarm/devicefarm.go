...
import (
	...
	"github.com/hortau/cdktf-provider-aws-go/devicefarm/internal"
)
...
func (j *jsiiProxy_DevicefarmDevicePool) Rule() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rule",
...
func NewDevicefarmDevicePool(scope constructs.Construct, id *string, config *DevicefarmDevicePoolConfig) DevicefarmDevicePool {
	...
	_jsii_.Create(
		"hashicorp_aws.devicefarm.DevicefarmDevicePool",
...
func (j *jsiiProxy_DevicefarmDevicePool) SetRule(val interface{}) {
	_jsii_.Set(
		j,
		"rule",
		val,
...
type DevicefarmDevicePoolConfig struct {
	...
	ProjectArn *string `json:"projectArn" yaml:"projectArn"`
	// rule block.
	//
	...
	MaxDevices *float64 `json:"maxDevices" yaml:"maxDevices"`
...
func NewDevicefarmInstanceProfile(scope constructs.Construct, id *string, config *DevicefarmInstanceProfileConfig) DevicefarmInstanceProfile {
	...
	_jsii_.Create(
		"hashicorp_aws.devicefarm.DevicefarmInstanceProfile",
		[]interface{}{scope, id, config},
		&j,
	)
...
type DevicefarmInstanceProfileConfig struct {
	...
	ExcludeAppPackagesFromCleanup *[]*string `json:"excludeAppPackagesFromCleanup" yaml:"excludeAppPackagesFromCleanup"`
	...
	PackageCleanup interface{} `json:"packageCleanup" yaml:"packageCleanup"`
	...
	RebootAfterUse interface{} `json:"rebootAfterUse" yaml:"rebootAfterUse"`
...
func NewDevicefarmNetworkProfile(scope constructs.Construct, id *string, config *DevicefarmNetworkProfileConfig) DevicefarmNetworkProfile {
	...
	_jsii_.Create(
		"hashicorp_aws.devicefarm.DevicefarmNetworkProfile",
		[]interface{}{scope, id, config},
		&j,
	)
...
type DevicefarmNetworkProfileConfig struct {
	...
	DownlinkBandwidthBits *float64 `json:"downlinkBandwidthBits" yaml:"downlinkBandwidthBits"`
	...
	DownlinkDelayMs *float64 `json:"downlinkDelayMs" yaml:"downlinkDelayMs"`
	...
	DownlinkJitterMs *float64 `json:"downlinkJitterMs" yaml:"downlinkJitterMs"`
	...
	DownlinkLossPercent *float64 `json:"downlinkLossPercent" yaml:"downlinkLossPercent"`
	...
	UplinkBandwidthBits *float64 `json:"uplinkBandwidthBits" yaml:"uplinkBandwidthBits"`
	...
	UplinkDelayMs *float64 `json:"uplinkDelayMs" yaml:"uplinkDelayMs"`
	...
	UplinkJitterMs *float64 `json:"uplinkJitterMs" yaml:"uplinkJitterMs"`
	...
	UplinkLossPercent *float64 `json:"uplinkLossPercent" yaml:"uplinkLossPercent"`
}
...
type DevicefarmProjectConfig struct {
	...
	DefaultJobTimeoutMinutes *float64 `json:"defaultJobTimeoutMinutes" yaml:"defaultJobTimeoutMinutes"`
...
func NewDevicefarmTestGridProject(scope constructs.Construct, id *string, config *DevicefarmTestGridProjectConfig) DevicefarmTestGridProject {
	...
	_jsii_.Create(
		"hashicorp_aws.devicefarm.DevicefarmTestGridProject",
		[]interface{}{scope, id, config},
		&j,
	)
...
type DevicefarmTestGridProjectConfig struct {
	...
	VpcConfig *DevicefarmTestGridProjectVpcConfig `json:"vpcConfig" yaml:"vpcConfig"`
}
...
func (j *jsiiProxy_DevicefarmTestGridProjectVpcConfigOutputReference) IsSingleItem() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"isSingleItem",
...
func NewDevicefarmTestGridProjectVpcConfigOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, isSingleItem *bool) DevicefarmTestGridProjectVpcConfigOutputReference {
	_init_.Initialize()

	j := jsiiProxy_DevicefarmTestGridProjectVpcConfigOutputReference{}

	_jsii_.Create(
		"hashicorp_aws.devicefarm.DevicefarmTestGridProjectVpcConfigOutputReference",
...
func NewDevicefarmTestGridProjectVpcConfigOutputReference_Override(d DevicefarmTestGridProjectVpcConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, isSingleItem *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DevicefarmTestGridProjectVpcConfigOutputReference) SetIsSingleItem(val *bool) {
	_jsii_.Set(
		j,
		"isSingleItem",
		val,
...
func NewDevicefarmUpload(scope constructs.Construct, id *string, config *DevicefarmUploadConfig) DevicefarmUpload {
	...
	_jsii_.Create(
		"hashicorp_aws.devicefarm.DevicefarmUpload",
		[]interface{}{scope, id, config},
		&j,
	)
